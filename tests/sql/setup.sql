-- QBML Test Tables Setup
-- Run this SQL manually to create test tables
...
CREATE TABLE qbml_users (
    ...
    status VARCHAR(20) DEFAULT 'active',  -- active, inactive, pending, deleted
...
-- ============================================
SELECT 'qbml_departments' as tbl, COUNT(*) as cnt FROM qbml_departments
UNION ALL SELECT 'qbml_users', COUNT(*) FROM qbml_users
UNION ALL SELECT 'qbml_user_profiles', COUNT(*) FROM qbml_user_profiles
UNION ALL SELECT 'qbml_categories', COUNT(*) FROM qbml_categories
UNION ALL SELECT 'qbml_products', COUNT(*) FROM qbml_products
UNION ALL SELECT 'qbml_orders', COUNT(*) FROM qbml_orders
UNION ALL SELECT 'qbml_order_items', COUNT(*) FROM qbml_order_items;
